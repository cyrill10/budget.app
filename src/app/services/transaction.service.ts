...
export class TransactionService {
  ...
  getTransactions(date: Date): Observable<Transaction[]> {
    return this.http.get<Transaction[]>(
      'transaction/list', {params: {date: date.getTime()}}).pipe(
  ...
  getTransactionsForVirtualAccount(virtualAccount: VirtualAccount, date: Date): Observable<TransactionElement[]> {
    if (virtualAccount !== undefined) {
      return this.http.get<TransactionElement[]>(
        'transaction/listByMonthAndVirtualAccount', {
          params: {
            date: date.getTime(),
  ...
  getTransactionsForRealAccount(account: Account, date: Date): Observable<TransactionElement[]> {
    if (account !== undefined) {
      return this.http.get<TransactionElement[]>(
        'transaction/listByMonthAndRealAccount', {
          params: {
            date: date.getTime(),
  ...
  addTransaction(transaction: Transaction): Observable<Transaction> {
    ...
    return this.http.post<Transaction>('transaction/add', transaction)
      .pipe(
  ...
  updateTransaction(transaction: Transaction): Observable<Transaction> {
    return this.http.put<Transaction>('transaction/update', transaction)
      .pipe(
        catchError(this.errorHandler.handleError)
      );
  }
  ...
  deleteTransaction(transaction: Transaction): Observable<any> {
    return this.http.delete('transaction/delete', {params: {transactionId: transaction.id}})
      .pipe(
        catchError(this.errorHandler.handleError)
      );
  }
  ...
  createDublicatesTillEndOfTheYear(transaction: Transaction): Observable<any> {
    return this.http.post('transaction/dublicate', transaction)
      .pipe(
        catchError(this.errorHandler.handleError)
      );
  }
